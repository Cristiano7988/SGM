    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('nucleos.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <textarea id="descricao" min="20" rows="6" class="form-control @error('descricao') is-invalid @enderror" name="descricao" autocomplete="descricao"></textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="inicio_rematricula" type="date" min="{{ date('Y-m-d', strtotime('-365 days')) }}" max="{{ date('Y-m-d', strtotime('+365 days')) }}" class="form-control @error('inicio_rematricula') is-invalid @enderror" name="inicio_rematricula" required autocomplete="inicio_rematricula">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="fim_rematricula" type="date" min="{{ date('Y-m-d', strtotime('-365 days')) }}" max="{{ date('Y-m-d', strtotime('+365 days')) }}" class="form-control @error('fim_rematricula') is-invalid @enderror" name="fim_rematricula" required autocomplete="fim_rematricula">
                            ...
                            <div class="col-md-8">
                                <select class="form-select" name="idade_minima_id" required>
                                    ...
                                    @foreach ($idadesMinimas as $idade_minima)
                                        <option value="{{ $idade_minima->id }}">{{ $idade_minima->idade }} {{ $idade_minima->medida_de_tempo->tipo }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-8">
                                <select class="form-select" name="idade_maxima_id" required>
                                    ...
                                    @foreach ($idadesMaximas as $idade_maxima)
                                        <option value="{{ $idade_maxima->id }}">{{ $idade_maxima->idade }} {{ $idade_maxima->medida_de_tempo->tipo }}</option>
                                    @endforeach
                                </select>
