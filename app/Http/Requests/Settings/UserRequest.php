    ...
    public function rules($user = false): array
    {
        ...
        return !request()->password
            ? [
                ...
                'whatsapp' => [$nullable, 'min:3', 'max:100', Rule::unique('users')->ignore($id)],
                'instagram' => ['nullable', 'string', 'url', 'min:5', 'max:255', Rule::unique('users')->ignore($id)],
                'cep' => ['nullable', 'string', 'min:8', 'max:9'],
                'pais' => [$nullable, 'string', 'min:2', 'max:50'],
                'estado' => ['nullable', 'string', 'min:2', 'max:70'],
                'cidade' => ['nullable', 'string', 'min:2', 'max:255'],
                'bairro' => ['nullable', 'string', 'min:2', 'max:255'],
                'logradouro' => ['nullable', 'string', 'min:2', 'max:255'],
                'numero' => ['nullable', 'integer', 'min:1', 'max:999999'],
                'complemento' => [$nullable, 'string', 'min:1', 'max:999999'],
                'alunos' => ['array'],
